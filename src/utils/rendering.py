...
def get_render_settings(
    ...
    full_proj_matrix = view_matrix.unsqueeze(0).bmm(opengl_proj_matrix.unsqueeze(0)).squeeze(0) # TODO: what's with the unnecessary unsqueeze and squeeze?
...
def render_gaussian_model(
    ...
    ###############
    # print("Debugging: ")
    # visible_points = renderer.markVisible(means3D)
    # print("VISIBLE: ", visible_points)
    # print("NUM VISIBLE: ", visible_points.sum())
    # raise
    ###############
